//kosta novokmet
//proverava ispravnost podataka, ispisuje gresku na samoj stranici u suprtonom
//prevent default sprecava da se forma submituje
...
function check_confirm_pass(event) {
  ...
  if (confirm_pass === "") {
    ...
    document.getElementById("confirm pass error").innerHTML =
      "Lozinke i potvrda lozinke se ne poklapaju. Molimo vas da se uverite da oba polja sadrže istu lozinku.";
    event.preventDefault();
  } else {
    document.getElementById("confirm pass error").innerHTML = "";
  }
...
function check_lastname(event) {
  ...
  if (lastname === "") {
    ...
    document.getElementById("lastname error").innerHTML =
      "Prezime ne sme sadrzati brojeve";
    event.preventDefault();
  } else {
    document.getElementById("lastname error").innerHTML = "";
  }
